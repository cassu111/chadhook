...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		menu_slider_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_slider_value_font = RENDER::CreateF("Verdana", 16, 500, 0, 0, NULL);
		menu_groupbox_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_combobox_name_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_combobox_value_font = RENDER::CreateF("Verdana", 16, 550, 0, 0, NULL);
		menu_separator_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_keybind_value_font = RENDER::CreateF("Verdana", 16, 550, 0, 0, NULL);
		menu_keybind_name_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_text_input_name_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_text_input_value_font = RENDER::CreateF("Verdana", 16, 550, 0, 0, NULL);
		menu_button_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_window_blurr_font = RENDER::CreateF("Verdana", 32, 550, 10, 0, NULL);
		menu_window_font = RENDER::CreateF("Verdana", 32, 550, 0, 10, NULL);
		menu_colorpicker_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);
		menu_tool_tip_font = RENDER::CreateF("Verdana", 18, 550, 0, 0, NULL);

		visuals_esp_font = RENDER::CreateF("Small Pixel7", 12, FW_MEDIUM, 0, 0, SDK::FONTFLAG_ANTIALIAS | SDK::FONTFLAG_DROPSHADOW); // Tahoma //Verdana, 11, 500, outline
		visuals_esp_font_small = RENDER::CreateF("Small Pixel7", 8, FW_NORMAL, 0, 0, SDK::FONTFLAG_OUTLINE);
		lby_indicator_font = RENDER::CreateF("Verdana", 28, 650, 0, 0, SDK::FONTFLAG_DROPSHADOW | SDK::FONTFLAG_ANTIALIAS);
		in_game_logging_font = RENDER::CreateF("Small Pixel7", 16, 550, 0, 0, SDK::FONTFLAG_OUTLINE);
